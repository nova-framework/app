...
return array (
  ...
  'Passwords must be strong enough and match the confirmation.' => 'Пароль должен быть достаточно сильным и совпадать с полем подверждения',
  'Please enter your e-mail address to be sent a link to reset your password.' => 'Пожалуйста, укажите ваш e-mail для отправления ссылки сброса пароля',
  'Purple' => 'Пурпурный',
  'Purple Light' => 'Светло-фиолетовый',
  'Red' => 'Красный',
  'Red Light' => 'Светло-красный',
  'Remember me' => 'Запомнить меня',
  'Required field' => 'Необходимые поля',
  'Reset instructions have been sent to your email address' => 'Инструкция по сбросу пароля отправлениы вам на e-mail адрес',
  'Reset your password for <b>{0}</b>' => 'Сброс вашего пароля на <b>{0}</b>',
  'SMTP' => 'SMTP',
  'Save' => 'Сохранить',
  'Send' => 'Отправить',
  ...
  'The :attribute field is invalid.' => 'Поле :attribute является неправильным',
  ...
  'This password reset token is invalid.' => 'Токен сброса пароля неправильный',
  ...
  'We can\'t find a User with that e-mail address.' => 'Мы не можем найти пользователя с таким e-mail адресом',
  ...
  'Yup. This is the Dashboard.' => 'Это рабочий стол',
  'executed.' => 'выполнено',
